...
const Login = () => {
  ...
  const loginAsDoctor = async () => {
    setEmail("dr.benani@example.com");
    setPassword("password");
  };
    ...
    <div className='min-h-screen bg-gray-50 py-12 flex flex-col justify-center'>
      <div className='sm:mx-auto sm:w-full sm:max-w-md'>
        ...
        <p className='mt-2 text-center text-sm text-gray-600'>
          ...
          <Link
            to='/register'
            className='font-medium text-medical-primary hover:text-medical-accent'
          >
            ...
            <div className='relative'>
              ...
              <div className='relative flex justify-center text-sm'>
                <span className='bg-white px-2 text-gray-500'>
                  Ou continuez avec des comptes de démonstration
                </span>
              </div>
            </div>

            <div className='mt-6 grid grid-cols-1 gap-3'>
              <Button type='button' variant='outline' onClick={loginAsPatient}>
              ...
              <Button type='button' variant='outline' onClick={loginAsDoctor}>
                Compte médecin de test
              </Button>
              <Button type='button' variant='outline' onClick={loginAsAdmin}>
